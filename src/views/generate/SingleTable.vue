  ...
  <div class="page-container">
    <div class="left-container">
      <div class="toolbar">
        <el-button
          size="medium"
          style="width:99%; padding-right:25px;"
          @click="getTables"
      ...
      <div class="left-tree">
        <el-tree
          ...
          ref="tree"
          size="medium"
          @node-click="selectTableChange"
          :filter-node-method="filterNode"
        >
          <span class="custom-tree-node" slot-scope="{ node, data }">
            <span>
              <li class="fa fa-table fa-lg"></li>
              {{ data.name }}
            </span>
          </span>
        </el-tree>
    ...
    <div class="right-container">
      ...
      <div class="option-info">
        <el-form ref="optionForm" class="optionForm" :inline="true" label-width="70px" size="small">
          <span>
            <el-form-item label="包名">
              <el-input v-model="generateModel.basePackage" placeholder="如: cn.stt.generate">
                <el-button
                  type="file"
                  slot="append"
                  icon="fa fa-folder fa-lg"
                  @click="chooseBasePackage"
                ></el-button>
              </el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getTables() {
      ...
      axios
        .post(this.baseUrl + "/getTables", JSON.parse(dsStr))
        .then(res => {
          res = res.data;
          if (res.code === 0) {
    ...
    tableSelectionChange(selections) {
      ...
      axios
        .post(this.baseUrl + "/getGenerateModel", params)
        .then(res => {
          res = res.data;
          if (res.code === 0) {
            this.generateModel = res.data;
            this.treeData = this.generateModel.tableModels;
            this.generateModel.outPutFolderPath = "d:\\generate_code";
    ...
    // 选择代码输出目录
    chooseBasePackage() {
      this.generateModel.basePackage = "cn.stt.generate";
    },
    // 选择代码输出目录
    chooseOutputFolder() {
      this.generateModel.outPutFolderPath = "d:\\generate_code";
    ...
    generateCode() {
      ...
      axios
        .post(this.baseUrl + "/generateModels", this.generateModel)
        .then(res => {
          res = res.data;
          if (res.code === 0) {
